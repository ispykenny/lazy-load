...
var _backgrounds = __webpack_require__(3);

var _images = __webpack_require__(4);

var all_images = document.querySelectorAll('img');

(0, _images.getImageRatio)(all_images);
if (all_images.length) {

  window.onload = function () {
    var allImages = document.querySelectorAll('img');
    (0, _images.initDomImages)(allImages);
    (0, _backgrounds.setBackgroundImages)();
  };
}
...
var setBackgroundImages = function setBackgroundImages() {
  var backgrounds = document.querySelectorAll('.bg__el');
  var observer = new IntersectionObserver(function (element) {

    element.forEach(function (backgroundElement) {
...
exports.setBackgroundImages = setBackgroundImages;
...
var setDomElement = function setDomElement(element, ratio, src, alt) {
  element.setAttribute("src", "");
  var wrapperEl = document.createElement("div");
  var parentEl = element.parentElement;

  wrapperEl.setAttribute("class", "image-el");
  wrapperEl.setAttribute("style", "position: relative; width: auto; height: 0px;");
  ...
  document.querySelectorAll(".lazy-image").forEach(function (image) {
    image.setAttribute("style", "position: absolute; top: 0; left: 0; width: 100%; height: 100%;");
  });
};

var getImageRatio = function getImageRatio(allDomImages) {
  var imgElement = allDomImages;
  ...
  imgElement.forEach(function (element) {
    ...
    if (element.offsetHeight <= 0) {
      var setDem = setInterval(function () {
        if (element.offsetHeight > 0) {
          var imageRatio = {
...
var initDomImages = function initDomImages(domImages) {
  var observer = new IntersectionObserver(function (element) {

    element.forEach(function (domImage) {
...
exports.initDomImages = initDomImages;
